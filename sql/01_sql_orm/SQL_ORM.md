...
2. user 레코드 생성
   ...
   ```python
   # orm
   user = User(first_name='지성',last_name='임',age=26,country='전라북도',phone='010-1234-5678',balance=1000000)
   user.save()
   ```
   ...
   VALUES(101,'지성','임',26,'전라북도','010-1234-5678',1000000);
   ```
...
8. 거주 지역이 강원도이면서 성이 황씨인 사람의 이름
   ...
   ```python
   # orm
   User.objects.get(Q(country='강원도')&Q(last_name='황')).first_name
```
